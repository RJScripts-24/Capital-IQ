...
HEADERS = ['Time'] + [f'V{i}' for i in range(1, 29)] + ['Amount', 'Category']
...
def generate_normal_transaction():
    ...
    return [time_step] + features + [amount, category]
